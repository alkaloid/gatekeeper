defmodule Gatekeeper.RfidTokenController do
  ...
  def index(conn, %{"company_id" => company_id, "member_id" => member_id}) do
  ...
  def new(conn, %{"company_id" => company_id, "member_id" => member_id}) do
    member = Repo.get!(Member, member_id) |> Repo.preload(:company) |> Repo.preload(:rfid_tokens)
    changeset = RfidToken.changeset %RfidToken{}
    render(conn, "new.html", changeset: changeset, member: member)
  end

  def create(conn, %{"company_id" => company_id, "member_id" => member_id, "rfid_token" => rfid_token_params}) do
    member = Repo.get!(Member, member_id) |> Repo.preload(:company) |> Repo.preload(:rfid_tokens)
  ...
  def show(conn, %{"company_id" => company_id, "member_id" => member_id, "id" => id}) do
  ...
  def edit(conn, %{"company_id" => company_id, "member_id" => member_id, "id" => id}) do
    rfid_token = Repo.get!(RfidToken, id) |> Repo.preload(:member)
    member = Repo.preload(rfid_token.member, :company)
  ...
  def update(conn, %{"company_id" => company_id, "member_id" => member_id, "id" => id, "rfid_token" => rfid_token_params}) do
    rfid_token = Repo.get!(RfidToken, id) |> Repo.preload(:member)
    member = Repo.preload(rfid_token.member, :company)
